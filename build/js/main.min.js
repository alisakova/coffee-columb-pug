...
var $input=$("#range"),$output=$("#output"),$price=$("._price"),$value=$("._value"),$input2=$("#range-2"),$output2=$("#output-2");$(document).ready(function(){if($input.length){function e(t){10<=($output[0].textContent=t)&&($value[0].textContent="~ 5 кг в месяц",$price[0].textContent="6500 руб."),16<=t&&($value[0].textContent="~ от 8 кг",$price[0].textContent="по договорённости"),t<10&&($value[0].textContent="~ 3 кг в месяц",$price[0].textContent="5000 руб.")}$input.on("input",function(t){e(t.target.value)}),$input.rangeslider({polyfill:!1}),e($input[0].value)}}),$(document).ready(function(){if($input2.length){function e(t){10<=($output2[0].textContent=t)&&($value[0].textContent="~ 5 кг в месяц",$price[0].textContent="7800 руб."),16<=t&&($value[0].textContent="~ от 8 кг",$price[0].textContent="по договорённости"),t<10&&($value[0].textContent="~ 3 кг в месяц",$price[0].textContent="6000 руб.")}$input2.on("input",function(t){e(t.target.value)}),$input2.rangeslider({polyfill:!1}),e($input2[0].value)}});
